 ...
 * @param input
 * @param rules - If rules is a string, the parameter defines the allowable input type as one of the following: 'boolean', 'string', 'number', 'function'. 
 ...
 * @returns {boolean}
 * @function dictionaryOfValidationFunctions
 */
